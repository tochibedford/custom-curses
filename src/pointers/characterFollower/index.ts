...
function init(canvas: HTMLCanvasElement, context: CanvasRenderingContext2D, objects: (TCharacter | TImageCharacter)[], pointer: PointerObject) {
    let focusPoint = {
        x: 0,
        y: 0
    }
 ...
 */
function animate(objectChar: TCharacter | TImageCharacter) {
